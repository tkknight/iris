...
A number of file formats are recognised by Iris, including
**CF-compliant NetCDF**, **GRIB**, and **PP**, and it has a plugin
architecture to allow other formats to be added seamlessly.
...
.. todo::
   ...
   * https://xarray.pydata.org/en/stable/getting-started-guide/why-xarray.html
   * https://numpy.org/doc/stable/user/whatisnumpy.html
   * https://docs.dask.org/en/latest/why.html

.. todo::
   * Explain what PP file format is?
   * Section headings? cubes (data structure/metadata), Goals and insipirations (Met focus, future - roadmap?)
